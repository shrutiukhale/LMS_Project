...
<header class="header">
   <section class="flex">
      ...
      <form action="search.html" method="post" class="search-form">
         <input type="text" name="search_box" required placeholder="Search report..." maxlength="100">
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="admins.html"><i class="fas fa-chalkboard-user"></i><span>Admins</span></a>
      <a href="courses.html"><i class="fas fa-graduation-cap"></i><span>Courses</span></a>
      <a href="report.html"><i class="fa-regular fa-eye"></i><span>Report</span></a>
